...
def scrape_event_links():
    """Összegyűjti a tippmixpro.hu főoldaláról az összes esemény teljes URL-jét,
    és visszaadja őket `https://sports2.tippmixpro.hu/{path}/all` formátumban."""
    with sync_playwright() as p:
        ...
        browser.close()
        return [f"https://sports2.tippmixpro.hu/{path}/all" for path in results]
